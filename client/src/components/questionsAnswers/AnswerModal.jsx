  ...
  return (
    <>
      <div className="modal">
        ...
        <div className="fixed top-0 mr-4 inset-x-1/4 translate-y-1/4 translate-x-2/4 leading-6 bg-neutral-50 border-4 rounded w-96 h-124">
          <form role="answer-form" className="ml-2 flex flex-col" onSubmit={(e) => {
            ...
            <textarea role="answer-form-body" required className="m-2 h-48" placeholder="Your answer"></textarea>
            <input role="answer-form-name" required className="m-2" placeholder="Example: jack543!"></input>
            <span className="m-2 text-xs">For privacy reasons, do not use your full name or email address</span>
            <input role="answer-form-email" required type="email" className="m-2" placeholder="Example: jack@email.com"></input>
